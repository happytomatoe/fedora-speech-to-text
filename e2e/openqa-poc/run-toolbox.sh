...
# Set PERL5LIB for os-autoinst modules - MUST be set BEFORE isotovideo starts
# so that vtdistribution.pm can find its base class 'distribution'
export PERL5LIB="/usr/lib/os-autoinst:${PERL5LIB:-}"

# Run isotovideo with vars as environment variables
